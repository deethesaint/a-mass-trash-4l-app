...
@section('content')
    <div class="px-2">
        <h1 class="font-semibold text-2xl mb-6 border-b-2 dark:border-b-indigo-900 dark:text-white">Bài viết mới</h1>
    </div>
    <div class="grid md:grid-cols-2 lg:grid-cols-2 gap-2 px-2">
        <div
            class="bg-gray-100 w-full rounded-xl overflow-hidden border-2 border-gray-200 hover:bg-gray-200 dark:text-white dark:border-indigo-900 dark:bg-transparent/5 dark:hover:bg-indigo-950 transition">
            <a href="#">
                <img class="w-full rounded-ss-xl rounded-se-xl object-cover hover:scale-105 h-52 ease-in-out transition duration-500"
            ...
            <div class="w-full text-end items-center justify-center px-2 my-1 pb-2">
                <p class="font-semibold">20-12-23 | DuongVu <span><img class="w-7 h-7 rounded-full inline border-2 mb-1"
                            src="https://brocanvas.com/wp-content/uploads/2022/01/hinh-anh-chu-cho-tai-cut.jpg"></span></p>
            </div>
        </div>
        <div
            class="bg-gray-100 w-full rounded-xl overflow-hidden border-2 dark:border-indigo-900 border-gray-200 hover:bg-gray-200 dark:text-white dark:bg-transparent/5 dark:hover:bg-indigo-950 transition">
            <a href="#">
                ...
                <p class="w-full px-2 mt-2 font-semibold text-base lg:text-lg">Post title... Post title... Post title...
                    Post
                    title... Post title... Post title... Post title... Post title... </p>
                <p class="w-full px-2 mt-1  line-clamp-3 lg:line-clamp-5 xl:line-clamp-6">ante eget velit sodales
                    commodo. Suspendisse lobortis aliquet pulvinar. Phasellus eget malesuada lacus, vitae volutpat felis.
        ...
        <div
            ...
            <div class="w-full text-end items-center justify-center px-2 my-1 pb-2">
                <p class="font-semibold">13-05-23 | DuongVu <span><img class="w-7 h-7 rounded-full inline border-2 mb-1"
                            src="https://brocanvas.com/wp-content/uploads/2022/01/hinh-anh-chu-cho-tai-cut.jpg"></span></p>
            </div>
        </div>
        <div
            ...
            <div class="w-full text-end items-center justify-center px-2 my-1 pb-2">
                <p class="font-semibold">22-08-23 | DuongVu <span><img class="w-7 h-7 rounded-full inline border-2 mb-1"
                            src="https://brocanvas.com/wp-content/uploads/2022/01/hinh-anh-chu-cho-tai-cut.jpg"></span></p>
            </div>
        </div>
        <div
            ...
            <div class="w-full text-end items-center justify-center px-2 my-1 pb-2">
                <p class="font-semibold">25-12-22 | DuongVu <span><img class="w-7 h-7 rounded-full inline border-2 mb-1"
                            src="https://brocanvas.com/wp-content/uploads/2022/01/hinh-anh-chu-cho-tai-cut.jpg"></span></p>
            </div>
        </div>
        <div
            ...
            <div class="w-full text-end items-center justify-center px-2 my-1 pb-2">
                <p class="font-semibold">25-01-24 | DuongVu <span><img class="w-7 h-7 rounded-full inline border-2 mb-1"
                            src="https://brocanvas.com/wp-content/uploads/2022/01/hinh-anh-chu-cho-tai-cut.jpg"></span></p>
            </div>
        </div>
        <div
            ...
            <div class="w-full text-end items-center justify-center px-2 my-1 pb-2">
                <p class="font-semibold">21-12-23 | DuongVu <span><img class="w-7 h-7 rounded-full inline border-2 mb-1"
                            src="https://brocanvas.com/wp-content/uploads/2022/01/hinh-anh-chu-cho-tai-cut.jpg"></span></p>
            </div>
        </div>
    </div>
